    ...
    <div className="relative" ref={rootRef}>
      ...
      {isOpen && panelPosition && createPortal(
        <div
          ...
          className={
            panelClassName ??
            'fixed z-[1600] flex w-[360px] max-w-[min(360px,calc(100vw-2rem))] flex-col overflow-hidden rounded-[28px] border border-slate-200/90 bg-white/98 shadow-[0_30px_60px_-28px_rgba(15,23,42,0.42)] ring-1 ring-white/80 backdrop-blur-xl'
          }
          ...
          <div className="border-b border-slate-100 bg-linear-to-r from-sky-50 via-white to-blue-50/70 px-4 py-4">
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0">
                ...
                <div className="mt-1 line-clamp-2 text-sm font-black leading-5 text-slate-900">{resourceName}</div>

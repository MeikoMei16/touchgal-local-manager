...
- renderer settings page now also exposes Library management open mode plus separate maintenance actions for database reset and cache clearing
...
- Settings page maintenance actions now split `reset database` and `clear cache` into two separately confirmed operations
